# Full-Stack Auth Demo: JWT + RBAC (LAB VERSION)

> This is the lab copy: eight pieces of the auth flow are blanked out
> as `TODO(1)`-`TODO(8)` for you to fill in during class. **Start with
> [LAB.md](LAB.md)** -- it walks through the TODOs in order with a
